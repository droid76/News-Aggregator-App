...
class Business extends Component 
{
    ...
    callGuardian()
    {
        fetch("https://csci571-node.azurewebsites.net/guardianBusiness").then(res=> { 
        return res.json();
            }).then(news_articles=> this.setState({articles:news_articles}));
    }
    callNyt()
    {
        fetch("https://csci571-node.azurewebsites.net/nytBusiness").then(res=> {
            return res.json();
        ...
        if(localStorage.getItem("checked")==='true')
        {
            ...
            return ( 
                <div style={{marginBottom:'2%'}}>
                {
                    ...
                    <Row>
                        <Card.Body  >
                        <Col xs={12} lg={3} xl={3} md={3} sm={3}  style={{}}>
                        ...
                        <Col xs={12} lg={9} xl={9} md={9} sm={9} style={{float:'right'}}>
                            ...
                            <ModalComponent title={article.webTitle} url = {article.webUrl}/>
                             ...
                             <span>
                                <TextTruncate line={3} text= {article.blocks.body[0].bodyTextSummary} />
                            </span>
